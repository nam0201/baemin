...
<section>
	...
	<table id="mun_history" width="600" align="center">		
		...
		<tr height="50">
			<td align="left" colspan="2"><b>${map.title}</b></td>
		</tr>
		<p>
		<tr>
			<td height="50" colspan="2" align="left">${map.writeday}</td>
		</tr>
		<tr id="pp">
		...
		<tr id="pp">
			...
			<td id="pp" align="left">${ fn:replace(map.content2, replaceChar, "<br/>") } <p></td>
		</tr>
		<tr height="50">
			<td colspan="2" align="center">
